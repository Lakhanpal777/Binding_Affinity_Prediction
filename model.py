...
# Save the model structure as a JSON file (optional)
model_json = model.to_json()
with open("model_structure.json", "w") as json_file:
    json_file.write(model_json)
print("\nModel structure saved as 'model_structure.json'.")

# Save the untrained model weights (optional)
model.save_weights("untrained_model_weights.h5")
print("\nUntrained model weights saved as 'untrained_model_weights.h5'.")
